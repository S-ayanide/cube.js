...
this attribute, and any valid partitions required to satisfy it are selected.
This results in faster refresh times and possibly reduced cost, depending on
your database.

Cube.js supports [both time][ref-preagg-time-part] and
[segment-based][ref-preagg-segment-part] partitioning. However, it first must be
